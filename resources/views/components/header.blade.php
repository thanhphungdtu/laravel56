    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-3 col-sm-12 text-center nopadding-right">
                <div class="top-logo">
                    <a href="index.html"><img src="{{ getenv('public_url') }}img/logo.gif" alt="" /></a>
                </div>
            </div>
            <!-- logo end -->
            <!-- mainmenu area start -->
                    ...
                    <!-- language division start -->
                     <div class="disflow">
                        <div class="expand lang-all disflow">
                            <a href="#"><img src="{{ getenv('public_url') }}img/country/laco.png" style="width: 18px;height: 12px;" alt="">Việt Nam</a>
                            <ul class="restrain language">
                                <li><a href="#"><img src="{{ getenv('public_url') }}img/country/it.gif" alt="">italiano</a></li>
                                <li><a href="#"><img src="{{ getenv('public_url') }}img/country/nl_nl.gif" alt="">Nederlands</a></li>
                                <li><a href="#"><img src="{{ getenv('public_url') }}img/country/de_de.gif" alt="">Deutsch</a></li>
                                <li><a href="#"><img src="{{ getenv('public_url') }}img/country/en.gif" alt="">English</a></li>
                            </ul>
                        </div>
                        <div class="expand lang-all disflow">
                            <a href="#">$ VNĐ</a>
                                               ...
                                               {{-- {{ dd($product) }}--}}
                                                <li>
                                                    <a class="sm-cart-product" href="">
                                                        @if(isset($product->options->avatar))
                                                    ...
                                                    <div class="small-cart-detail">
                                                        ...
                                                        <a href="#" class="edit-btn"><img src="{{ getenv('public_url') }}img/btn_edit.gif" alt="Edit Button" /></a>
                                                        <a class="small-cart-name" href="">{{ $product->name }}</a>
                                                        <span class="quantitys"><strong>{{ $product->qty }}</strong>x<span>{{ number_format($product->price,0,',','.') }}đ</span></span>
                                                    </div>
                                                </li>
                                            @endforeach
                                        @endif
                                    </ul>
                                    <p class="total">Subtotal: <span class="amount">{{ str_replace(',','.',Cart::subtotal(0,3)) }} VNĐ</span></p>
                                    <p class="buttons">
                                ...
                                <div class="container nopadding-right">
                                    <form action="{{ route('product.search') }}" id="searchform" method="get">
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="search" value="{{ Request::get('search') }}" maxlength="128" placeholder="Tìm kiếm sản phẩm...">
