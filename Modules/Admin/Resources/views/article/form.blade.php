...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <p><img src="{{ pare_url_file($article->a_avatar) }}" alt="" style="width: 80px;"><img src="{{ asset('/public/theme_admin/images/default-image.jpg') }}" id="out_img" alt="" width="80px" height="80px"></p>
        @endif
    </div>
